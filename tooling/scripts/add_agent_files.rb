#!/usr/bin/env ruby
# Adds Swift files under NotchNerd/Agent/ to the Agent PBXGroup + the NotchNerd
# app target's Sources build phase. Idempotent. Required because NotchNerd/Agent
# is a normal PBXGroup (not a synchronized folder) — new files are NOT auto-built.
#
# Usage (from repo root):
#   ruby tooling/scripts/add_agent_files.rb File1.swift File2.swift ...
require "xcodeproj"

PROJECT       = File.expand_path("NotchNerd.xcodeproj", Dir.pwd)
GROUP_SUBPATH = "NotchNerd/Agent"
