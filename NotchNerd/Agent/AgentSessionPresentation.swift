//
//  AgentSessionPresentation.swift
//  NotchNerd — Agent session presentation helpers
//
//  Copied verbatim from Open Island's `AgentSession+Presentation.swift`
//  (open-vibe-island, GPL v3, Octane0411). These are pure, dependency-free
//  computed properties over the vendored `OpenIslandCore.AgentSession` — no
//  Open Island app-layer dependencies. Kept close to the upstream so it can be
//  re-synced cleanly. See THIRD_PARTY_LICENSES / LICENSE (GPL v3).
//
